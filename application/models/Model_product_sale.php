<?
class Model_product_sale extends MY_Model {
    ...
    // Get User data
    public function find_all_product_sale($product_id = 0)
    {
        // Set params
        ...
        $params['joins'][] = array(
            "table"=>"color" ,
            "joint"=>"color.color_id = product_sale.mba_color_id",
        );
    ...
    */
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
              ...
              'mba_flash_sale_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'mba_flash_sale_id',
                     'label'   => 'Product Sale ID#',
                     'type'   => 'hidden',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
