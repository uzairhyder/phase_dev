...
class Model_inner_banner extends MY_Model
{
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "inner_banner_id,inner_banner_name,CONCAT(inner_banner_image_path,inner_banner_image) AS inner_banner_image,inner_banner_status";
