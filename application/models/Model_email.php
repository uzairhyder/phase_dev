...
class Model_email extends MY_Model {
    ...
    public function inquiry_email($user_data)
    {
        ...
        $message .=  'Email :-' .   $user_data['inquiry_email']. "<br />";
        $message .=  'Phone Number :-' .  $user_data['inquiry_phone']. "<br />";
        $message .=  'State Location :-' .  $user_data['inquiry_promo_code']. "<br />";
        $message .=  'Message :-' .  $user_data['inquiry_comments']. "<br />";
