...
//        $this->pagination_params['fields'] = "{pre}brand.brand_id,{pre}brand.brand_type,{pre}brand.brand_name,
        $this->pagination_params['fields'] = "brand_id,brand_name,brand_status";
    ...
    public function get_brands_with_count($cat_id=0)
    {
        $params['fields'] = "*, (select count(product_category_id) from mt_product where product_brand_id=brand_id and product_status=1) as cat_count";
