...
//        $this->pagination_params['fields'] = "{pre}category.category_id,{pre}category.category_type,{pre}category.category_name,
        $this->pagination_params['fields'] = "category_id,category_name,category_navigation,category_status";
    ...
    // Get Prices count
    public function get_prices_count()
    {
        $params['fields'] = "
        (select
        ";
    ...
    public function get_categories_with_count($cat_id=0)
    {
        $params['fields'] = "*, (select count(product_category_id) from mt_product where product_category_id=category_id and product_status = 1) as cat_count";
           ...
           /* 'category_banner_image' => array(
            ...
            'category_image' => array(
              ...
              'category_navigation' => array(
                     ...
                     'type_dt'   => 'dropdown',
                     'type_filter_dt' => 'dropdown',
                     'list_data_key' => "category_navigation" ,
                      'list_data' => array(
                          0 => "<span class='label label-danger'>Hide</span>" ,
                          1 =>  "<span class='label label-primary'>Show</span>"
                      ) ,
                     'default'   => '1',
                     'attributes'   => array(),
