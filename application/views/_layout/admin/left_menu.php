...
$menu_links = array(
    ...
    */
    ...
    array("title" => "Layout", "icon" => "clip-screen", "action" => array("promotional_banner", "", "cms_page", "cms_title", "logo","prospect","headings","nav_bar"),
        "additionals" => array(
            ...
            array("link" => "headings", "title" => "Headings", "icon" => "folder"),
            array("link" => "nav_bar", "title" => "Nav Headings", "icon" => "folder"),
    ...
    array("title" => "Banner Management", "icon" => " fa fa-image", "action" => array("banner","inner_banner"),
        "additionals" => array(
            array("link" => "banner", "title" => "Manage Banner", "icon" => " fa fa-picture-o"),
...
// Testimonials
   ...
   /* array("title" => "E-Book Management", "icon" => " fa fa-book", "action" => array("item","category","special_book",
    ...
    array("title" => "Camp Management", "icon" => " fa fa-folder-open", "action" => array("camp","camp_result"),
        "additionals" => array(
            array("link" => "camp", "title" => "Manage Camps", "icon" => " fa fa-picture-o"),
            array("link" => "camp_year", "title" => "Manage Camp Result Year", "icon" => " fa fa-picture-o"),
            array("link" => "camp_result", "title" => "Manage Camp Results", "icon" => " fa fa-picture-o"),
        ),
    ),

     array("title" => "Kickoff Management", "icon" => " fa fa-folder-open", "action" => array("kicker_year","kicker_ranking"),
        "additionals" => array(
            array("link" => "kicker_year", "title" => "Manage Years", "icon" => " fa fa-picture-o"),
            array("link" => "kicker_ranking", "title" => "Manage Ranking", "icon" => " fa fa-picture-o"),
        ),
    ),

    array("title" => "Field Goal Management", "icon" => " fa fa-folder-open", "action" => array("field_goal_year","field_goal_ranking"),
        "additionals" => array(
            array("link" => "field_goal_year", "title" => "Manage Years", "icon" => " fa fa-picture-o"),
            array("link" => "field_goal_ranking", "title" => "Manage Ranking", "icon" => " fa fa-picture-o"),
        ),
    ),


    array("title" => "Punter Management", "icon" => " fa fa-folder-open", "action" => array("punter_year","punter_ranking"),
        "additionals" => array(
            array("link" => "punter_year", "title" => "Manage Years", "icon" => " fa fa-picture-o"),
            array("link" => "punter_ranking", "title" => "Manage Ranking", "icon" => " fa fa-picture-o"),
        ),
    ),


    array("title" => "Snapper Management", "icon" => " fa fa-folder-open", "action" => array("snapper_year","snapper_ranking"),
        "additionals" => array(
            array("link" => "snapper_year", "title" => "Manage Years", "icon" => " fa fa-picture-o"),
            array("link" => "snapper_ranking", "title" => "Manage Ranking", "icon" => " fa fa-picture-o"),
        ),
    ),
    ...
    */
     ...
     // Blog Management
     array("title"=>"Media Management", "icon"=>" fa fa-circle-o-notch" ,"action" => array("blog_category","blog","comment") ,
         "additionals"=>array(
...
//     ),
    ...
    array("title" => "Team Management", "icon" => " fa fa-users", "action" => "team",
        "additionals" => array(
            array("link"=>"team","title"=>"Manage Team", "icon"=>"fa fa-users"),
        ),
    ),

    array("title" => "Sponsor Management", "icon" => " fa fa-gift", "action" => "sponsor",
        "additionals" => array(
            array("link"=>"sponsor","title"=>"Manage Sponsor", "icon"=>"fa fa-gift"),
        ),
    ),

    array("title" => "SEO Management", "icon" => " fa fa-line-chart", "action" => "seo_plugin",
        "additionals" => array(
            array("link"=>"seo_plugin","title"=>"Manage SEO", "icon"=>"fa fa-line-chart"),
        ),
    ),
