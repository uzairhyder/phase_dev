...
<?php foreach ($snapper_year  as $key => $value) {
    if ($key % 2 == 0) { ?>
        <div class="row">
            ...
            <div class="col-md-6" style="padding:0px;">
                <div class="row">
                    <div class="col-md-12" style="padding: 0;">
                      <a href="<?php echo g('base_url'); ?>snapper/detail/<?php echo $value['snapper_year_slug']; ?>">  <img src="<?php echo get_image($value['snapper_year_image_path'], $value['snapper_year_image']); ?>"  width="100%"> </a>
                    </div>
                    <div class="transfer">
                        <h4 style="color:#fff;"><a href="<?php echo g('base_url'); ?>snapper/detail/<?php echo $value['snapper_year_slug']; ?>" style="color:#fff;"><?= $value['snapper_year_title'] ?></a></h4>
                    </div>
                </div>
