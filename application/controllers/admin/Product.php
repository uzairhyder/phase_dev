...
class Product extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->dt_params['dt_headings'] = "product_id,product_category_id,product_name,product_is_best_deal,product_is_week,product_hot_sale,product_is_search,product_status";
        $this->dt_params['searchable'] = array("product_id","product_category_id","product_name","product_is_best_deal","product_is_week","product_is_search","product_hot_sale","product_status");
