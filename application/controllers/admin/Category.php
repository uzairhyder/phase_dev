...
class Category extends MY_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->dt_params['dt_headings'] = "category_id,category_name,category_navigation,category_status";
        $this->dt_params['searchable'] = array("category_name","category_navigation","category_status");
