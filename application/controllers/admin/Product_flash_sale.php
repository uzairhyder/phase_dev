...
class Product_flash_sale extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->dt_params['dt_headings'] = "product_flash_sale_id,product_flash_sale_status";
        $this->dt_params['searchable'] = array("product_flash_sale_id","product_flash_sale_status");
